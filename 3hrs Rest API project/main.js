function addToNewExpense(event)
{
    ...
    axios.post("https://crudcrud.com/api/832cb351c44b4837ac6dcefec8d1e8b8/appointmentData", obj)
    .then((response) =>
    {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get("https://crudcrud.com/api/832cb351c44b4837ac6dcefec8d1e8b8/appointmentData")
    .then((response) => {
        console.log(response)
...
function showUserOnScreen(obj)
{
    ...
    deleteButton.onclick = () =>
    {
        ...
        const url = `https://crudcrud.com/api/832cb351c44b4837ac6dcefec8d1e8b8/appointmentData/${obj._id}`;
        axios.delete(url)
            .then(() => {
                parentElement.removeChild(childElement);
            })
